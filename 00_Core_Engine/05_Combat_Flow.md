...
- **成功結果**:
    ...
    - プレイヤーは以下の **2つの選択肢 (Choice)** から処遇を決定する。
        ...
        2.  **【介錯 (Finish Off)】**: その場でトドメを刺す。即座に **XP** と **Gold**、**通常ドロップ** を獲得する。
- **失敗結果**:
...
| **Submission** | **2** | `2d6 + Char/Pow` | **`2d6 + Rank`** |
...
**GM Note**: 
戦闘は「削り合い」ではなく「物語の転換点」です。
HP30%以下になった際、ただ攻撃して殺すのか、それともSPを支払って【屈服】させるのか。
その選択こそが、このRPGの醍醐味です。
