...
class GameState:
    ...
    def __init__(self):
        ...
        self.scenario_phase: str = "mainline"
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "branch_turns_remaining": self.branch_turns_remaining,
            "merge_theme_index": self.merge_theme_index,
    ...
    def from_dict(self, data: dict):
        ...
        self.scenario_phase = data.get("scenario_phase", "mainline")
        self.branch_turns_remaining = data.get("branch_turns_remaining", 0)
        self.merge_theme_index = data.get("merge_theme_index", 0)
        self.total_branches = data.get("total_branches", 0)
