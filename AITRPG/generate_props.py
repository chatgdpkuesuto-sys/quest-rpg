...
# ※ 全体がしっかり収まるように生成する
PROPS = {
    "grass": "tall grass patch, full view, centered, object only",
    "table": "wooden tavern table, full view, centered, object only",
    "desk": "old wooden desk, scattered papers, full view, centered, object only",
    "signboard": "wooden signboard, full view, centered, object only",
    "bushes": "dense green bushes, full view, centered, object only",
    "magic_circle_ground": "glowing magic circle on the floor, flat perspective, full view, centered",
    "crystals": "glowing blue crystals, stalagmites, full view, centered",
    "window_frame": "stone window frame, full view, centered",
}

# 共通プロンプト
PROP_BASE = "masterpiece, best quality, newest, object only, no humans, simple background, green background, chroma key"
NEGATIVE = "1girl, 1boy, character, human, person, text, watermark, bad quality, blurry, cropped, out of frame"
...
def build_workflow(prop_text: str) -> dict:
    ...
    return {
        ...
        "6": {
            ...
            "inputs": {"width": 512, "height": 512, "batch_size": 1}  # 全体が映るように512x512
        },
        "2": {
            "class_type": "KSampler",
            "inputs": {
