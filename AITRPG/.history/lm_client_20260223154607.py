...
class LMClient:
    ...
    def generate_candidates(self, exclude_names: list[str] = None) -> list[dict]:
        ...
        sys_prompt = (
            ...
            f"{exclude_str}\n"
            "※非常に重要※ 完全なランダム性を重視してください。メジャーなキャラクターだけでなく、マニアックな作品、古い作品、最新の作品など、幅広いジャンルのアニメ・ゲームから、毎回全く異なるヒロインを3人選出してください。定番キャラに偏らないようにしてください。\n"
            "ランダムな女子アニメキャラクター、または美少女ゲームヒロインを3人、"
            "名前・原作名・性格・特徴（スキル等）とともに考えてください。\n"
            "出力は必ず以下のJSON形式のみとし、他のテキストは一切出力しないでください。\n"
            "[\n"
            "  {\"name\": \"キャラ名\", \"origin\": \"原作名\", \"personality\": \"性格\", \"desc\": \"簡単な説明\"},\n"
            "  {\"name\": \"キャラ名\", \"origin\": \"原作名\", \"personality\": \"性格\", \"desc\": \"簡単な説明\"},\n"
            "  {\"name\": \"キャラ名\", \"origin\": \"原作名\", \"personality\": \"性格\", \"desc\": \"簡単な説明\"}\n"
            "]"
        )
