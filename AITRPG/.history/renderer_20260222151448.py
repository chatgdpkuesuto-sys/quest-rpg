    ...
    def render(self) -> Optional[int]:
        ...
        if self.current_image:
            if self.fading_in:
                ...
                if self.current_chara:
                    chara_x = self.screen_w // 2 - self.current_chara.get_width() // 2 + 150
                    chara_y = self.screen_h - self.current_chara.get_height()
                    self.screen.blit(self.current_chara, (chara_x, chara_y))
                if self.current_prop:
