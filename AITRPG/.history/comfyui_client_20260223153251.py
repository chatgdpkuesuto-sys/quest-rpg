...
class ComfyUIClient:
    ...
    def __init__(self, config: Optional[dict] = None):
        ...
        self.talotto_workflow_file = r"c:\Users\kuesu\OneDrive\Desktop\AITRPG\ワークフロウ\TALOTTO.json"
    ...
    def generate_party_chara(self, soul_name: str, job_name: str = "") -> Optional[Path]:
        ...
        base_prompt = self.SOUL_PROMPTS.get(soul_name, "1boy, fantasy, anime style")
        if job_name:
            job_tags = {
