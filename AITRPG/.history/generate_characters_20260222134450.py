...
POSES = {
    ...
    "look_back": "from behind, looking back at viewer",
}

# キャラ共通部分
CHARA_BASE = "masterpiece, best quality, newest, 1girl, solo, elf, pointy ears, silver hair, long flowing hair, blue eyes, fantasy white and gold robes, holding wooden staff, witch hat, full body, boots"
CHARA_BG = "simple background, green background, chroma key"
NEGATIVE = "cropped, out of frame, worst quality, low quality, oldest, early, displeasing, complex background, scenery, depth of field, drop shadow, 3d, realistic, blurry, bad anatomy, text, watermark"
