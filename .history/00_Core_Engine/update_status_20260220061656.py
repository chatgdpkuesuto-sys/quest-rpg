    ...
    try:
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            if S_ZETCHOU in content or S_AHHH in content:
                ...
                # Desktop Flash Event!
                flash_script = os.path.join(ROOT_DIR, '00_Core_Engine', 'trigger_desktop_flash.ps1')
                if os.path.exists(flash_script):
                    subprocess.Popen(["powershell", "-ExecutionPolicy", "Bypass", "-File", flash_script], creationflags=subprocess.CREATE_NO_WINDOW)
