...
# ライブサーバーのルート（00_Dashboard）配下に保存する
DEST_DIR = r"c:\Users\kuesu\GEM_Project_Root\00_Dashboard\outputs"
...
try:
    while True:
        ...
        if current_latest and current_latest != last_file:
            ...
            # ダッシュボードからの相対パス（ダッシュボード内部なので outputs/latest.png）
            status_data["current_image"] = "outputs/latest.png"
            status_data["status"] = "updated_by_sync_script"
