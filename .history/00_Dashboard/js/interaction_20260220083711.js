...
function triggerClimax() {
    ...
    window.mirrorScale = Math.random() > 0.5 ? 1 : -1;

    // 1. AIへ送信
    sendAction(window.pendingClimax.action, window.pendingClimax.x, window.pendingClimax.y);
...
function setupInteraction() {
    document.addEventListener('mousedown', (event) => {
        ...
        window.targetOriginX = xPercent;
        window.targetOriginY = yPercent;
        window.zoomBoost = 0.3;
