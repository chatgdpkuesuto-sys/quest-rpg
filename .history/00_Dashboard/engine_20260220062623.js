...
async function pollGameState() {
    try {
        ...
        // Update Background Image if provided and changed
        if (state.current_image && !bgImage.src.endsWith(state.current_image.substring(2))) { // ../等の簡略判定
            bgImage.src = state.current_image;
        }
