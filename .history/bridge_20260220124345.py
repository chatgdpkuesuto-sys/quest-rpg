...
def handle_action():
    try:
        ...
        if action == "CONFIRM_STATS_INTENT":
            ...
            state["current_dialogue"] = f"救世主の魂を受理しました。【{stat_text}】の器を持つあなたに、契約するヒロインを選んでいただきます。"
            ...
            state["current_dialogue"] = "能力値の再設定を受け付けました。改めて定義してください。"
            state["current_monologue"] = "時は巻き戻された。汝の魂、その真なる形を問い直す時だ。"
...
if __name__ == '__main__':
    print("=" * 40)
    print("🧠 MACHADUN Neural Bridge (自律型)")
